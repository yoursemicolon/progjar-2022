...
window=Tk()
window.title("TicTacToe Player1")
...
mainFrame = Frame (window, bg = '#B00000', bd=10,width = 1350, height=600, relief=RIDGE)
mainFrame.grid(row=1,column=0)

leftFrame = Frame (mainFrame ,bd=10, width =750, height=500, pady=2, padx=10, bg="#B00000", relief=RIDGE)
leftFrame.pack(side=LEFT)

rightFrame = Frame (mainFrame,bd=10, width =560, height=500, padx=10, pady=2, bg="#999999", relief=RIDGE)
...
btnQuit=Button (rightFrame3, text="Quit", font=('poppins', 20, 'bold'), height = 1, width =15,command = clickQuit)
...
lblGames=Label(rightFrame2, font=('poppins', 18, 'normal'), text=" ",padx=2, pady=2, bg="#FEA803",width=8)
lblGames.grid (row=0, column=1, sticky=W)
lbl=Label(rightFrame2, font=('poppins', 18, 'normal'), text="Won:",padx=2, pady=2, bg="#FEA803")
lbl.grid (row=1, column=0, sticky=W)
lblWon=Label(rightFrame2, font=('poppins', 18, 'normal'), text=" ",padx=2, pady=2, bg="#FEA803",width=8)
...
lblLost=Label(rightFrame2, font=('poppins', 18, 'normal'), text=" ",padx=2, pady=2, bg="#FEA803",width=8)
...
lblTies=Label(rightFrame2, font=('poppins', 18, 'normal'), text=" ",padx=2, pady=2, bg="#FEA803",width=8)
lblTies.grid (row=3, column=1, sticky=W)

lbl=Label(rightFrame1, font=('poppins', 18, 'normal'), text="Host:",padx=2, pady=2, bg="#FEA803")
lbl.grid (row=0, column=0, sticky=W)
lblUsername=Label(rightFrame1, font=('poppins',18, 'normal'), text="player1",padx=2, pady=2, bg="#FEA803",width=10, justify=RIGHT)
lblUsername.grid (row=0, column=1, sticky=W)
lbl=Label(rightFrame1, font=('poppins', 18, 'normal'), text="Turn: ",padx=2, pady=2, bg="#FEA803")
lbl.grid (row=1, column=0, sticky=W)
lblTurn=Label(rightFrame1, font=('poppins', 18, 'normal'), text="opponent",padx=2, pady=2, bg="#FEA803",width=10)
