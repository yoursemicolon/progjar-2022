...
alldata['7']=dict(nomor=7, nama="basiw andra", posisi="bek kanan Grup B")
alldata['8']=dict(nomor=8, nama="ludwig anchor", posisi="bek tengah kanan Grup B")
...
def run_server(server_address,is_secure=False):
    ...
    while True:
        ...
        try:
            ...
            threading.Thread(target=handle_request, args=(connection, server_address)).start()
...
if __name__=='__main__':
    try:
        ...
        logging.warning("Proses Multi Thread Selesai")